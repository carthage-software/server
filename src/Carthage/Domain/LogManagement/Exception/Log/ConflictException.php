...
final class ConflictException extends DomainException implements ExceptionInterface
{
     ...
     */
    public static function whenCreatingMessageThatAlreadyExists(Identity $logIdentity, string $namespace, Level $level, string $template): self
    {
        return new self(Str\format(self::CREATE_LOG_ALREADY_EXISTS_MESSAGE, $namespace, $level->value, $template, $logIdentity->value));
    }
}
