...
namespace Carthage\Domain\MetricCollection\Filter\Gauge;

use Carthage\Domain\MetricCollection\Filter\Metric\MetricDataPointFilter;
use Carthage\Domain\Shared\Criteria;

final class GaugeDataPointFilter extends MetricDataPointFilter
{
    /**
     * @var int|float|null The minimum value of the gauge data point filter. Null if not provided.
     */
    public int|float|null $minValue = null;

    /**
     * @var int|float|null The maximum value of the gauge data point filter. Null if not provided.
     */
